...
public class TupleDesc {
	...
	public String toString() {
		// some code goes here
		String describing_descripter="";
        for(int i=0; i<types.length; i++){
        	describing_descripter = describing_descripter + types[i] + "(" + names[i] +")";
            if(i==types.length || i != types.length-1)
            	describing_descripter = describing_descripter + "|";
        }
        return describing_descripter;
        }
	}
