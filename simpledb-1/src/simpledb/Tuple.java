...
public class Tuple {
    ...
    // some code goes here
    	String reperesent_tuple ="";
    	for(int i = 0 ;i<fields.length;i++)
    	{
    		reperesent_tuple = reperesent_tuple + fields[i];
    		if (i != fields.length-1 || i == fields.length)
    			reperesent_tuple = reperesent_tuple  +  "|";
    	}
    	return reperesent_tuple;
    }
}
